...
Base="/Users/dxh0619/Dropbox/NEXT-PhotobleachData/Photobleach/"
Dye = "MagGreen" # Dye name from directory
Concentration = "1micromol" # Dye concentration from directory
Run = "Run3" # Run number from directory
...
#Path= Base+Dye"\\"+Concentration+"\\"+Run+"\\
...
Long_Dye = "Magnesium Green" # Full name of dye for graph labels
Long_Concentration = "1 $\mu$M" # Concentration for graph labels
Integration_Time = "2000 ms" # Integration time of run
Laser_Power = "300 $\mu$W" # Laser power of run
